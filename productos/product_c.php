<?php
    ...
    if(isset($_POST['submit'])){
        ...
        setcookie('product_c', $amount, time() + 86400);
    }
...
<body>
    ...
    <div class="products-ind">
        <div id="product-wrapper" class="card-group">
            <div class="card">
                <img src="../content/card.jpg" class="card-img-top"  height='400'>
                <div class="card-body">
                <h5 class="card-title">Baraja "Bicycle"</h5>
                <p class="card-text">Baraja de cartas (francesa) de marca "Bicycle", una de las marcas mas reconocidos en el mercado de barajas de cartas.</p>
                <p class="card-text"><small class="text-muted">7'99 eur</small></p>
                <form action="product_c.php" method="POST">
