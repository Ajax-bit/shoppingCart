<?php
    ...
    if(isset($_POST['submit'])){
        ...
        setcookie('product_b', $amount, time() + 86400);
    }
...
<body>
    ...
    <div class="products-ind">
        <div id="product-wrapper" class="card-group">
            <div class="card">
                <img src="../content/pen.jpeg" class="card-img-top" height='400'>
                <div class="card-body">
                <h5 class="card-title">Lote bolígrafos "Milan"</h5>
                <p class="card-text">Aunque tras usarlo unos 3 días se queda sin tinta, son indiscutiblemente unos de los bolígrafos mas bonitos en el mercado.</p>
                <p class="card-text"><small class="text-muted">3'99 eur</small></p>
                <form action="product_b.php" method="POST">
